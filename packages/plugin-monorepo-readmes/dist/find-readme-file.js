 ...
 */
const findReadmeFile = (readmeTargets, moduleMapping, readme) => {
    ...
    for (const target of readmeTargets) {
        ...
        const readmeFile = (() => {
            if (readme === null || readme === void 0 ? void 0 : readme.length) {
                for (const name of readme) {
                    if ((0, fs_1.existsSync)((0, path_1.join)(pkgDir, name)))
                        return name;
                }
                return;
            }
            return (0, fs_1.readdirSync)(pkgDir).find(f => f.toLowerCase() === 'readme.md');
        })();
        if (readmeFile) {
